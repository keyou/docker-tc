...
LABEL maintainer="keyou" \
      org.opencontainers.image.title="docker-tc" \
      org.opencontainers.image.description="Docker Traffic Control" \
      org.opencontainers.image.authors="Łukasz Lach <llach@llach.pl>;keyou" \
      org.opencontainers.image.documentation="https://github.com/keyou/docker-tc" \
